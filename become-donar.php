...
if(mysqli_query($conn, $sql)) 
	   {
    echo "<div class='alert alert-success' >Message Sent. We will contact you shortly</div>";
    }
    else 
    {
...
while ($result = mysqli_fetch_array($query))
 {
?>
  <option value="<?php echo htmlentities($results['BloodGroup']);?>"><?php echo htmlentities($result['BloodGroup']);?></option>
